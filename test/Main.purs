...
isoTest1 :: forall a b c d. (a -> b -> c -> d) -> Fn (Cons a (Cons b (Cons c Nil))) d
isoTest1 = to

isoTest2 :: forall a b c d. Fn (Cons a (Cons b (Cons c Nil))) d -> a -> b -> c -> d
isoTest2 = from

isoTest3 :: forall a b c d. (Tuple a (Tuple b c) -> d) -> Fn (Cons a (Cons b (Cons c Nil))) d
isoTest3 = to

isoTest4 :: forall a b c d. Fn (Cons a (Cons b (Cons c Nil))) d -> (Tuple a (Tuple b c) -> d)
isoTest4 = from
